...
export default function BrandSlotsScreen({ onNext, onBack, slots = [], onSelectSlot }) {
...
const styles = StyleSheet.create({
  ...
  slotCard: {
    width: '100%',
    height: 110, // Increased layout height slightly to support multi-line data text frames cleanly
    borderRadius: 16,
    borderWidth: 1.5,
    borderColor: '#3A3A3C',
    borderStyle: 'dashed',
  ...
  slotCardActive: {
    ...
    alignItems: 'flex-start', // Left align text layers matching your design reference
  },
  slotCardText: { color: '#A032E6', fontSize: 16, fontWeight: '600' },
  filledContentContainer: { flex: 1, justifyContent: 'center', width: '100%' },
  promptTitleText: {
    color: '#E5243F', // Red brand prompt text alignment
    fontSize: 14,
    fontWeight: 'bold',
    marginBottom: 8,
    letterSpacing: 0.5,
  ...
  promptAnswerText: {
    ...
    fontSize: 15,
    fontWeight: 'bold',
    fontStyle: 'italic', // Quotation bold-italic design pattern
  },
  nextButton: { backgroundColor: '#E5243F', height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginHorizontal: 24, marginBottom: 24 },
